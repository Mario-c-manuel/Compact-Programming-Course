...
// Define SortMethod locally since import isn't working
enum SortMethod {
  NAME_AZ = 'name_az',
  NAME_ZA = 'name_za', 
  FEFO = 'fefo',
...
// Your Java backend base URL - CHANGE THIS PORT IF NEEDED!
const API_BASE_URL = 'http://localhost:60327';
